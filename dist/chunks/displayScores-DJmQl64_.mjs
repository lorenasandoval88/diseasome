...
function renderPgsFromSelection() {
	...
	const title = `PGS Catalog Scoring Files - ${scores.length} of ${totalAvailableScores} scores (${catLabel}${traitLabel})`;
	...
	const renderPage = () => {
		...
		scoresDiv.innerHTML = `
			...
			<div class="mb-2">
				...
				<div class="small text-muted mt-1">Showing ${filtered.length} of ${scores.length} scores</div>
			</div>
...
//# sourceMappingURL=displayScores-DJmQl64_.mjs.map
